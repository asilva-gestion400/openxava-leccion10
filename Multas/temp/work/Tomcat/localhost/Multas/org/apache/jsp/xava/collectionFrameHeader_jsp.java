...
if (!collectionView.isCollectionFromModel()) {
	...
	if (collectionView.isCollectionEditable()) {
      ...
      try {
        ...
        // /xava/collectionFrameHeader.jsp(42,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005fimage_005f0.setAction(collectionView.getNewCollectionElementAction());
        // /xava/collectionFrameHeader.jsp(42,0) name = argv type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
