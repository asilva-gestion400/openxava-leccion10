 ...
 * Generated at: 2021-03-08 15:17:43 UTC
...
public final class reference_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/xava/htmlTagsEditor.jsp", Long.valueOf(1612455954910L));
    ...
    _jspx_dependants.put("/xava/referenceActionsExt.jsp", Long.valueOf(1612455957424L));
    _jspx_dependants.put("/WEB-INF/openxava.tld", Long.valueOf(1612455958619L));
    _jspx_dependants.put("/xava/referenceActions.jsp", Long.valueOf(1612455956214L));
...
String label = ref.getLabel(request);
 ...
 if (view.isFlowLayout()) { 
	...
	if (frame) {
      ...
      out.write(" \n");
      out.write("\t<div class='");
      out.print(noFrame?"":"ox-flow-layout");
      out.write('\'');
      out.write('>');
      out.write('\n');
 } 
 ...
 if (labelFormat == MetaPropertyView.NORMAL_LABEL) { 
      ...
      try {
        ...
        // /xava/reference.jsp(62,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
...
if (labelFormat == MetaPropertyView.SMALL_LABEL) { 
      ...
      try {
        ...
        // /xava/reference.jsp(71,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
...
String script = throwChanged?
 ...
 String required = view.isEditable() && ref.isRequired() ? "class='" + style.getRequiredEditor() + "'":""; 
      ...
      try {
        ...
        // /xava/reference.jsp(135,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
